...
### Prerequisites
- Node.js 18+
- Google Gemini API key (free — get at https://aistudio.google.com/apikey)
...
### Frontend
The React frontend (`App.jsx`) can be:
- Run as a standalone React app with Vite
- Deployed on Vercel (free tier) pointing to the backend API
